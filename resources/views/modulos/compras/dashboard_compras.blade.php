                                ...
                                <div class="table-wrap">
                                    <table id="datable_1" class="table table-hover w-100 display pb-30">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edicion_material" data-id="{{$material->id}}" data-descripcion="{{$material->descripcion}}" data-cantidad="{{$material->cantidad_solicitada}}">
