        ...
        <div class="hk-pg-wrapper">
            ...
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ingenieria</li>
                </ol>
            </nav>
            <!-- /Breadcrumb -->
            ...
            <div class="container-fluid">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"></span></span>Módulo Ingenieria </h4>
                </div>

                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800"> </h1>
                    <a href="{{route('exportar_ingenieria')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generar reporte</a>
                </div>
                <!-- /Title -->
                <div class="row">
                    <div class="col-xl-12">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="width: 200px;">
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cargar_dibujo" data-ot="{{$dibujo->ot}}">
                                                            <i class="icon-plus"></i>
                                                        </button>
                                                    </td>
                                                    <td>{{$dibujo->ot}}</td>
