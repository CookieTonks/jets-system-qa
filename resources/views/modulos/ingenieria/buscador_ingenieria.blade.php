        ...
        <div class="hk-pg-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"></span></span>Buscador Ingenieria </h4>
                </div>
                <!-- /Title -->
                <div class="row">
                    <div class="col-xl-12">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="width: 200px;">
                                                        <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#cargar_dibujo" data-ot="{{$dibujo->ot}}">
